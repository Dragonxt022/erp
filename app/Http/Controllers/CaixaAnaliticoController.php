...
class CaixaAnaliticoController extends Controller
{
    ...
    // {
    //     // Obter a data atual caso nenhuma data seja enviada
    //     $data = $request->input('data', now()->format('d-m-Y'));
    ...
    //     // Converter a data recebida para o formato do banco (Y-m-d)
    //     try {
    //         $dataConvertida = \Carbon\Carbon::createFromFormat('d-m-Y', $data)->format('Y-m-d');
    //     } catch (\Exception $e) {
    //         return response()->json(['error' => 'Formato de data inválido. Use o formato DD-MM-YYYY.'], 400);
    //     }

    //     // Definir horários com base no período
    //     $inicioDoDia = $dataConvertida . ' 00:00:00';
    //     $fimDoDia = $dataConvertida . ' 23:59:59';
    //     $meioDia = $dataConvertida . ' 12:00:00';

    //     // Lógica para definir o intervalo de tempo
    //     if ($periodo === 'almoco') {
